...
VALUES ('Ася', '2011-01-01', 'кс-кс-кс', 1),
('Барсик', '2016-01-01', "отставить!", 1),  
('Мира', '2017-01-01', "", 1); 
...
VALUES ('Рекс', '2020-01-01', 'ко мне, лежать, лапу, голос', 2),
('Рагдай', '2021-06-12', "сидеть, лежать, лапу", 2),  
('Ставр', '2018-05-01', "сидеть, лежать, лапу, след, фас", 2), 
('Ласка', '2021-05-10', "сидеть, лежать, фу, место", 2);
...
VALUES ('Малышик', '2020-10-12', '', 3),
('Тимка', '2021-03-12', "атака сверху", 3),  
('Афоня', '2022-07-11', NULL, 3), 
('Уголек', '2022-05-10', NULL, 3);
...
VALUES ('Сила', '2020-01-12', 'бегом, шагом', 1),
('Чемпион', '2017-03-12', "бегом, шагом, хоп", 1),  
('Коршун', '2016-07-12', "бегом, шагом, хоп, брр", 1), 
('Воин', '2020-11-10', "бегом, шагом, хоп", 1);
...
('Ида', '2015-07-12', "повернись", 3), 
('Агата', '2022-12-10', "улыбнись", 3);
```
...
```
13. Создать [класс с Инкапсуляцией методов и наследованием по диаграмме.](https://github.com/AntoninaProject/Kennel_account_system/tree/main/System/src/Model)

14. Написать [программу, имитирующую работу реестра домашних животных](https://github.com/AntoninaProject/Kennel_account_system/tree/main/System/src). 
